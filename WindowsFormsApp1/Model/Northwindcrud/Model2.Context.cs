...
namespace WindowsFormsApp1.Model.Northwindcrud
{
    ...
    public partial class NORTHWNDEntities : DbContext
    {
        ...
        [DbFunction("NORTHWNDEntities", "GetEmployee")]
        public virtual IQueryable<GetEmployee_Result> GetEmployee(Nullable<int> supplierid)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetEmployee_Result>("[NORTHWNDEntities].[GetEmployee](@supplierid)", supplieridParameter);
        }
    
        [DbFunction("NORTHWNDEntities", "GetEmployeeandcustomer")]
        public virtual IQueryable<GetEmployeeandcustomer_Result> GetEmployeeandcustomer(Nullable<int> orderid)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetEmployeeandcustomer_Result>("[NORTHWNDEntities].[GetEmployeeandcustomer](@orderid)", orderidParameter);
        }
    
        [DbFunction("NORTHWNDEntities", "GetEmployeeId")]
        public virtual IQueryable<GetEmployeeId_Result> GetEmployeeId(Nullable<int> supplierid)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetEmployeeId_Result>("[NORTHWNDEntities].[GetEmployeeId](@supplierid)", supplieridParameter);
        }
    
        [DbFunction("NORTHWNDEntities", "Getthenumberofordersofcustomer")]
        public virtual IQueryable<Getthenumberofordersofcustomer_Result> Getthenumberofordersofcustomer(Nullable<int> orderid)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Getthenumberofordersofcustomer_Result>("[NORTHWNDEntities].[Getthenumberofordersofcustomer](@orderid)", orderidParameter);
        }
