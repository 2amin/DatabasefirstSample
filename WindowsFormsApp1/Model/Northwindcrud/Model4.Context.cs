...
namespace WindowsFormsApp1.Model.Northwindcrud
{
    ...
    public partial class NORTHWNDEntities1 : DbContext
    {
        ...
        [DbFunction("NORTHWNDEntities1", "GetEmployee")]
        public virtual IQueryable<GetEmployee_Result> GetEmployee(Nullable<int> supplierid)
        {
            var supplieridParameter = supplierid.HasValue ?
                new ObjectParameter("supplierid", supplierid) :
                new ObjectParameter("supplierid", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetEmployee_Result>("[NORTHWNDEntities1].[GetEmployee](@supplierid)", supplieridParameter);
        }
    
        [DbFunction("NORTHWNDEntities1", "GetEmployeeandcustomer")]
        public virtual IQueryable<GetEmployeeandcustomer_Result> GetEmployeeandcustomer(Nullable<int> orderid)
        {
            var orderidParameter = orderid.HasValue ?
                new ObjectParameter("orderid", orderid) :
                new ObjectParameter("orderid", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetEmployeeandcustomer_Result>("[NORTHWNDEntities1].[GetEmployeeandcustomer](@orderid)", orderidParameter);
        }
    
        [DbFunction("NORTHWNDEntities1", "GetEmployeeId")]
        public virtual IQueryable<GetEmployeeId_Result> GetEmployeeId(Nullable<int> supplierid)
        {
            var supplieridParameter = supplierid.HasValue ?
                new ObjectParameter("supplierid", supplierid) :
                new ObjectParameter("supplierid", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetEmployeeId_Result>("[NORTHWNDEntities1].[GetEmployeeId](@supplierid)", supplieridParameter);
        }
    
        [DbFunction("NORTHWNDEntities1", "Getthenumberofordersofcustomer")]
        public virtual IQueryable<Getthenumberofordersofcustomer_Result> Getthenumberofordersofcustomer(Nullable<int> orderid)
        {
            var orderidParameter = orderid.HasValue ?
                new ObjectParameter("orderid", orderid) :
                new ObjectParameter("orderid", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Getthenumberofordersofcustomer_Result>("[NORTHWNDEntities1].[Getthenumberofordersofcustomer](@orderid)", orderidParameter);
        }
        ...
        public virtual ObjectResult<GetEmployeeandcustomerProc_Result> GetEmployeeandcustomerProc(Nullable<int> orderId)
        {
            var orderIdParameter = orderId.HasValue ?
                new ObjectParameter("OrderId", orderId) :
                new ObjectParameter("OrderId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetEmployeeandcustomerProc_Result>("GetEmployeeandcustomerProc", orderIdParameter);
        }
    
        public virtual int InsertRolePerson(string customerid, string companyname)
        {
            var customeridParameter = customerid != null ?
                new ObjectParameter("customerid", customerid) :
                new ObjectParameter("customerid", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertRolePerson", customeridParameter, companynameParameter);
        }
        ...
        public virtual int UD_UpdatMpbile()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UD_UpdatMpbile");
        }
    
        public virtual int UDP_UpdatMpbile()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UDP_UpdatMpbile");
        }
    }
}
